...
namespace Demo_Kethua
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            personC.input();//vẫn gọi input của lớp con Student (override) đã ghi đè lên input của lớp cha
            personC.display();//gọi display của lớp cha Person do display() ở Student sử dụng new (tạo bản sao riêng)
        }
    }
}
